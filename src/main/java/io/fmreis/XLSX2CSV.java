...
public class XLSX2CSV {
    ...
    private class SheetToCSV implements SheetContentsHandler {
        ...
        private int currentCol = starColumn;
    ...
    public static void main(String[] args) throws Exception {
        ...
        file = new File("/home/fmreis/IdeaProjects/xlsx2csv/src/main/resources/poi_test.csv");
        fop = new PrintStream(file);
